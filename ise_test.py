...
def main():
    ...
    try:
        ...
        def test_run():
            ...
            try:
                ...
                if num_test_failed == 0:
                    ...
                    print('You are printing in your project')
        ...
        def second_parse_check():
            global test_number, num_test_failed, results_summary, output_path
            try:
            ...
            for term in expected_terms:
                ...
                try:
                    ...
                    print(
                        f'Test Number: {test_number} The term {term} was not found in your inverted index')
            if num_test_failed == 0:
                print('Second Parser tests passed')
        ...
        def check_csv():
            ...
            try:
                ...
                print('Could Not find file results.csv')
        ...
        def check_report():
            ...
            try:
                ...
                print('Could Not find file report.docx')
